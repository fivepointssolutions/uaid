...
Gem::Specification.new do |s|
  ...
  s.files = ["lib/uaid", "lib/uaid/user_agent.rb", "lib/uaid/view_helper.rb", "lib/uaid.rb", "spec/spec.opts", "spec/spec_helper.rb", "spec/user_agent_spec.rb", "spec/view_helper_spec.rb"]
